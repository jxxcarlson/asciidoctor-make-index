...
index_term::['resources, volume of, foo bar', 1, mark]
...
index_term::['marginal product of labour', 3, mark]
+
...
called index_term::['’frictional’ unemployment', 4, mark]. For a realistic
...
*F* +
<<index_term_4, frictional unemployment>> +


*M* +
<<index_term_3, marginal product of labour>> +
...
*R* +
<<index_term_1, resources, volume of>> +
