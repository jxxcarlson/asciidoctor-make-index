...
The index_term::[classical theory of employment, 0] — supposedly
...
index_term::[marginal product of labour, 1]
+
...
called index_term::[’frictional’ unemployment, 2]. For a realistic
...
<<index_term_0, classical theory of employment>> +
<<index_term_1, marginal product of labour>> +
<<index_term_2, ’frictional’ unemployment>> +
